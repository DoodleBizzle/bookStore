...
const NavBar = () => {
  ...
  const {setEditAddress, setAddNewAddress} = useContext(profileContext)
  ...
  return (
    <nav className="navbar navbar-dark fixed-top bg-dark">
      ...
      <div className='nav-right d-flex flex-row align-items-center'>
        {isLoggedIn ?
          <>
            <NavLink className='nav-link' to='/profile' onClick={handleProfileClick}><h2>Profile</h2></NavLink>
            ...
            <NavLink className='nav-link' to="/" onClick={handleLogoutClick}><h2>Logout</h2></NavLink>
          </>
          :
          <>
